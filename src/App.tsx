...
import { PrimarySetupForm } from "./components/PrimarySetupForm"; // <-- New component
...
function App() {
  ...
  const handleConvertToImport = () => {
    setConfig(c => ({ ...c, operation: 'IMPORT', logfile: c.logfile.replace(/\.log$/i, '_import.log'), table_exists_action: 'SKIP'}));
  };
  ...
  const generateCommand = () => {
    ...
    if (outputMode === 'parfile') return `nohup ${opCommand} parfile=your_parfile.par &`;
